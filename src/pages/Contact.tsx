      ...
      <section className="py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="text-center p-8 bg-wise-lightblue rounded-2xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="bg-wise-lightblue p-8 rounded-2xl">
                <div className="mb-6">
      ...
      <section className="py-20 bg-wise-lightblue">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-12">
            ...
            <button className="bg-wise-green text-white px-8 py-3 rounded-lg font-semibold hover:bg-wise-darkgreen transition-colors duration-200">
              Contact Support
            </button>
          </div>
        </div>
