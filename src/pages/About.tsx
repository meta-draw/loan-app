      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-wise-navy mb-6">Our story</h2>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-sm">
              <div className="w-16 h-16 bg-wise-green/10 rounded-lg flex items-center justify-center mb-6">
                <svg className="w-8 h-8 text-wise-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <h3 className="text-xl font-semibold text-wise-navy mb-4">Transparency</h3>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm">
              ...
              <h3 className="text-xl font-semibold text-wise-navy mb-4">Speed</h3>
              <p className="text-wise-gray">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm">
              ...
              <h3 className="text-xl font-semibold text-wise-navy mb-4">Customer First</h3>
              <p className="text-wise-gray">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {team.map((member, index) => (
              <div key={index} className="text-center">
                ...
                />
                <h3 className="text-xl font-semibold text-wise-navy mb-2">
                  {member.name}
                </h3>
