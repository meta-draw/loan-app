      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            <div 
              key={index} 
              className="border border-gray-200 rounded-lg overflow-hidden hover:border-wise-green/30 transition-colors"
            >
              <button
        ...
        <div className="text-center mt-12 p-8 bg-wise-lightblue rounded-xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
              href="tel:1800QUICKLOAN" 
              className="inline-flex items-center justify-center bg-wise-green text-white px-6 py-3 rounded-lg font-semibold hover:bg-wise-darkgreen transition-colors"
            >
            ...
            <button className="inline-flex items-center justify-center bg-white text-wise-navy px-6 py-3 rounded-lg font-semibold border border-wise-navy hover:bg-wise-navy hover:text-white transition-colors">
              <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
