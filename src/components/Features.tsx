  ...
  const features = [
    {
      ...
      description: 'Get funds transferred to your account in just 60 seconds after approval.'
    },
    {
      icon: (
        <svg className="w-12 h-12 text-wise-bright-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Complete your application in just 5 minutes online. No paperwork needed.'
    },
    {
      icon: (
        <svg className="w-12 h-12 text-wise-bright-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: '5.95% fixed fee',
      description: 'Simple, transparent pricing. No hidden fees or surprises.'
    }
  ];
      ...
      <section className="py-20 bg-gradient-to-r from-wise-bright-green to-wise-success">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-2xl text-white/90 mb-8 max-w-2xl mx-auto">
            Apply in 5 minutes. Get funds in 60 seconds. Bad credit considered.
          </p>
          <Button 
