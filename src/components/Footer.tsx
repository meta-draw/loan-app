        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-xl font-bold">QuickLoan</h3>
            </div>
            ...
            <div className="flex space-x-4">
              <a 
                href="#" 
                className="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center hover:bg-wise-green transition-colors duration-200"
              >
